        ...
        <div class="col-lg-8 order-lg-2 mb-3">
          <div class="card shadow" style="border-radius:12px;">
            <div class="card-body">
              <div v-if="isLoggedIn">
                <button
                  class="btn btn-danger rounded-pill float-right"
                  @click="unfollowUser"
                  v-if="isFollowed"
                >
                  <span>
                ...
                <button class="btn btn-primary rounded-pill float-right" @click="followUser" v-else>
                  <span>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <span class="badge badge-primary mr-1">
                    ...
                    <span v-if="followerCount.length > 1 || !followerCount">s</span>
                  </span>
  ...
  mounted() {
    this.$bind("user", db.collection("users").doc(this.$route.params.id)),
      this.$bind(
        ...
        db
          .collection("users")
          .where("user.following", "array-contains", this.$route.params.id)
      ),
      this.$bind(
        "currentUser",
